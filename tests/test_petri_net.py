...
class TestPetriNet(unittest.TestCase):
    ...
    def test_add_place(self):
        self.petri_net.add_place("P1", 2, 5)
        ...
        self.petri_net.add_place("P2", 0, 3)
    ...
    def test_add_transition(self):
        self.petri_net.add_place("P1", 1, 5)
        self.petri_net.add_place("P2", 2, 4)
        self.petri_net.add_place("P3", 0, 3)
    ...
    def test_add_transition_2(self):
        self.petri_net.add_place("P1", 1, 3)
        self.petri_net.add_place("P2", 3, 6)
        self.petri_net.add_place("P3", 0, 3)
